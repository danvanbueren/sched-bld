...
/**
 * The {@code MeterGrounding} class is used to instantiate an object containing
...
public class MeterGrounding {
	...
	public MeterGrounding(int x, int y) {
	...
	public MeterGrounding(int x, int y, int width, int height) {
	...
	public void setState(MeterState s) {
		...
		case GREEN:
			...
			break;
		case YELLOW:
			pnlMain.setBorder(new LineBorder(Constants.darkYellow, 2));
			pnlMain.setBackground(Constants.yellow);
			break;
		case RED:
